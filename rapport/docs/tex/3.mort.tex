...
comme il le réclamait dans sa chanson «J'suis snob»\ldots ç'eut été la
...
l'origine une bonne blague, l'aura finalement achevé. Ironie finie et finale, quand
on sait qu'il est mort d'une crise cardiaque lors de la première
projection d'une adaptation de son \oe{}uvre dont il avait essayé d'empêcher 
la naissance. Las. Par une vengeance d'une bassesse innommable,
...
vivrai pas jusqu'à \nb{40} ans», a-t-il dit un jour\footnote{D'après Noël
\bsc{Arnaud}, dans \emph{Les vies parallèles de Boris Vian}, il n'aurait
pas appris cela de la bouche d'un médecin, mais aurait pu réaliser le pronostic
lui-même en se documentant par ses propres moyens.}. On en vient presque à
...
J'ai intégré ce texte car je je trouve très fort et représentant bien ce
sentiment de fin inéluctable et d'impuissance de \BV\ldots
...
En ayant à l'esprit toutes (ou ne serait-ce même qu'une partie) les activités,
...
frénésie des premières années passée, dans l'ambiance plus feutrée du \emph{Club
Saint-Germain}.
...
et sa première (ré-)édition par les Éditions du Chêne pour cela. }, l'éditeur ayant
fait faillite entre-temps.
...
ce qui a retardé ma découverte des écrits de \BV; on trouve des établissements scolaires nommés en
...
La Bibliothèque nationale de France à, d'ailleurs, entre octobre \nb{2011} et janvier \oldstylenums{2012}, présenté
