...
J'ai toujours été marqué par le regard que porte \BV\ sur la société
...
C'est peut-être aussi une des raison de mon admiration pour \BV. J'apprécie moi-même beaucoup
...
de compères, s'il on en croit la respectable liste de \nb{500} textes de chansons
...
on mettait toujours, dans la voiture, une cassette de Henri \bsc{Salvador}, qui
...
Ami d'auteurs comme Raymond \bsc{Queneau} ou Jacques \bsc{Prévert}\footnote{De qui il sera le voisin, partageant une
